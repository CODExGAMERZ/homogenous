...
Write-Host "`n✦ Installing Homogenous CLI v4.0.1 (Local-First Coding Assistant)..." -ForegroundColor Cyan
...
Write-Host "`n✓ Homogenous CLI v4.0.1 installed successfully!" -ForegroundColor Green
