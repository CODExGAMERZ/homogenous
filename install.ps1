...
Write-Host "`n✦ Installing Homogenous CLI v3.9.5 (Local-First Coding Assistant)..." -ForegroundColor Cyan
...
Write-Host "`n✓ Homogenous CLI v3.9.5 installed successfully!" -ForegroundColor Green
