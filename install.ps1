...
Write-Host "`n✦ Installing Homogenous CLI v4.2.5 (Local-First Coding Assistant)..." -ForegroundColor Cyan
...
Write-Host "`n✓ Homogenous CLI v4.2.5 installed successfully!" -ForegroundColor Green
