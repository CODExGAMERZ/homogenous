...
Write-Host "`n✦ Installing Homogenous CLI v4.0.2 (Local-First Coding Assistant)..." -ForegroundColor Cyan
...
Write-Host "`n✓ Homogenous CLI v4.0.2 installed successfully!" -ForegroundColor Green
