...
Write-Host "`n✦ Installing Homogenous CLI v3.7.6 (Local-First Coding Assistant)..." -ForegroundColor Cyan
...
Write-Host "`n✓ Homogenous CLI v3.7.6 installed successfully!" -ForegroundColor Green
