...
Write-Host "`n✦ Installing Homogenous CLI v4.0.0 (Local-First Coding Assistant)..." -ForegroundColor Cyan
...
Write-Host "`n✓ Homogenous CLI v4.0.0 installed successfully!" -ForegroundColor Green
