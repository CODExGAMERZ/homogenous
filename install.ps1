...
Write-Host "`n✦ Installing Homogenous CLI v4.2.6 (Local-First Coding Assistant)..." -ForegroundColor Cyan
...
Write-Host "`n✓ Homogenous CLI v4.2.6 installed successfully!" -ForegroundColor Green
