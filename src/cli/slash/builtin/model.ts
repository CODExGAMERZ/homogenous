      ...
      const cloudDefs: Array<{ id: KeyProvider; name: string; defaultModels: Array<{ name: string; tag: string }> }> = [
        ...
        },
        {
          ...
          defaultModels: [
            ...
            { name: "deepseek-ai/deepseek-r1", tag: "DeepSeek R1 Frontier (671B)" },
