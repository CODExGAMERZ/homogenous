...
echo -e "\n\033[1;36m✦ Installing Homogenous CLI v3.4.1 (Local-First Coding Assistant)...\033[0m"

# 1. Verify Node.js
if ! command -v node &> /dev/null; then
    echo -e "\033[1;31m✗ Error: Node.js (v20 or higher) is required but not found.\033[0m"
    echo -e "\033[1;33mPlease install Node.js from https://nodejs.org/ and rerun this script.\033[0m"
    exit 1
fi
...
echo -e "\n\033[1;32m✓ Homogenous CLI v3.4.1 installed successfully!\033[0m"
