...
[![Tests: 102 Passed](https://img.shields.io/badge/TESTS-102%20PASSED-39FF14?style=for-the-badge)](test/)
...
```
 ╭────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╮
 │ ✦ HOMOGENOUS AGENT v4.2.6 (Local-First Assistant)                                     workspace: /projects/core [main] │
...
```bash
# Run all 102 automated unit tests
npm test
...
<p align="center">
  <b>✦ HOMOGENOUS CLI v4.2.6 — Code Faster. Deploy Safer. Local First. ✦</b>
</p>
